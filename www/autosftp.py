...
def validate_location():
    ...
    if ip in ipaddress.ip_network("149.155.144.0/255.255.248.0") or ip in ipaddress.ip_network("149.155.134.0/255.255.255.0") or ip in ipaddress.ip_network("10.200.144.0/255.255.248.0"):
        return
